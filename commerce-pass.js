...
(function () {
  ...
  const products = {
    'brumas': { href: 'produto-bruma-ambiente', label: 'Ver Névoa de Ambiente', name: 'Névoa de Ambiente MAISON JF®' },
    'escalda-pes': { href: 'produto-escalda-pes', label: 'Ver Escalda-Pés', name: 'Escalda-Pés MAISON JF®' },
    'oleo': { href: 'produto-oleo-massagem', label: 'Ver Óleo de Massagem', name: 'Óleo de Massagem MAISON JF®' },
    'aguas-lencois': { href: 'produto-aguas-lencois', label: 'Ver Águas de Lençóis', name: 'Águas de Lençóis MAISON JF®' },
    'velas-aromaticas': { href: 'produto-vela-aromatica', label: 'Ver Vela Aromática', name: 'Vela Aromática MAISON JF®' }
  };
  ...
  function connectHomeCards() {
    const map = {
      'Névoa de Ambiente': 'produto-bruma-ambiente',
      'Velas Aromáticas': 'produto-vela-aromatica',
      'Escalda-Pés': 'produto-escalda-pes',
      'Óleo de Massagem': 'produto-oleo-massagem',
      'Águas de Lençóis': 'produto-aguas-lencois'
    };
  ...
  function addCatalogueSchema() {
    if (page !== 'produtos' || document.getElementById('maison-product-pages-schema')) return;
  ...
  if (page === 'produtos') connectProductCards();
  if (page === 'index') connectHomeCards();
  addCatalogueSchema();
