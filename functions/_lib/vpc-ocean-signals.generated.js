...
export const VPC_OCEAN_SIGNALS=[
  ...
  {
    "id": "pressao-social-para-gastar-e-vergonha-de-dizer-nao",
    "painLanguage": "Há convívios, celebrações e planos em que o custo não está apenas no preço: dizer «não cabe no meu orçamento» pode parecer admitir fracasso, desiludir alguém ou arriscar ficar de fora, levando a gastar para proteger pertença, imagem ou vínculo.",
    "intent": "reconhecer quando pertença, celebração ou imagem social empurram a pessoa para gastar além do que quer ou pode, tornando legítimo estabelecer limites financeiros sem transformar orçamento em vergonha nem isolamento",
    "themes": [
      "gastar para não ficar de fora",
      "vergonha de dizer que não cabe no orçamento",
      "pertença vs pressão para gastar",
      "limites financeiros entre amigos",
      "celebrar sem provar poder de compra",
      "dizer não sem desaparecer do grupo",
      "presentes e ocasiões sem competição de preço"
    ]
  },
  {
