...
export const MAISON_OFFER_CATALOGUE=[
  ...
  {id:'presenca',family:'presence',stage:'deeper',format:'service',title:'Presença',description:'Quando o que procuras não é uma resposta, mas alguém contigo num plano combinado.',href:'/portas/companhia#formatos',amount:null,priceLabel:'Sob consulta',axes:['belong','attachment'],territories:['presenca'],routes:['talk','gesture'],base:5},
