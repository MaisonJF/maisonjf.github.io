...
export const MAISON_OFFER_CATALOGUE=[
  ...
  {id:'tarot-expresso',family:'consultation',stage:'deeper',format:'service',title:'Tarot · Uma pergunta',description:'Uma pergunta concreta e uma leitura directa para deixares de andar às voltas no mesmo ponto.',href:'/servicos/tarot/#tarot-expresso',amount:1700,priceLabel:'17 €',axes:['control','direction','security','seen'],territories:['cabeca'],routes:['talk','selfpaced'],base:4},
  ...
  {id:'tarot',family:'consultation',stage:'deeper',format:'service',title:'Tarot · Uma consulta',description:'Mais contexto para quando a pergunta parece simples, mas há outras coisas por baixo.',href:'/servicos/tarot/#tarot',amount:3500,priceLabel:'35 €',axes:['control','direction','attachment','seen','security'],territories:['cabeca','presenca'],routes:['talk'],base:5},
