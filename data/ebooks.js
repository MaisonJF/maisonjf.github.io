window.MAISON_EBOOKS=[
  {
    ...
    price:5.99,currency:'EUR',cover:'/images/ebooks/para-de-ignorar.webp',media:[{role:'cover',src:'/images/ebooks/para-de-ignorar.webp',alt:'Capa do ebook Pára de Ignorar!, de João Fadario',aspect:'book',caption:'Pára de Ignorar! · João Fadario'}],purchaseUrl:null,featured:true
  },
  {
