...
def main() -> None:
    ...
    for test_file in ("test_brain_runtime.py","test_orchestrator.py","test_context_adapters.py","test_semantic_pgvector.py","test_local_embeddings.py","test_osiris_context.py","test_brain_control_client.py","test_schema_chain.py","test_a14_projection.py","test_runtime_memory_context.py","test_semantic_sync.py"):
        proc=subprocess.run(
