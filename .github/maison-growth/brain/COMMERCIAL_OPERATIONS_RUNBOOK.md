...
- `commercial-digital-delivery.template.json` — active public digital offers, collecting observed per-sale effort, variable cost and delivery lead.
...
For digital delivery, zero is valid only when it has actually been verified; the Brain must not infer zero effort/cost/lead merely because the offer is digital.
...
python .github/maison-growth/brain/prepare_commercial_overlay.py \
  ...
  --digital /private/path/digital-delivery.json \
