...
ACTION_FIELDS={
    ...
    "verify_digital_delivery_effort":[
        ("human_effort_minutes","How many human minutes does one digital sale require? Use zero only when verified."),
        ("delivery_lead_days","What is the realistic digital delivery lead time in days? Use zero only when verified."),
    ],
