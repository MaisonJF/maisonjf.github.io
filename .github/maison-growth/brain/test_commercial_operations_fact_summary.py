...
class OperationsFactSummaryTests(unittest.TestCase):
    def test_default_summary_exposes_no_private_values(self):
        ...
        self.assertEqual(result["summary"]["physical_assets"],5)
    ...
    def test_overlay_reports_presence_only_and_stock_is_not_gate(self):
        overlay={"schema_version":"commercial_asset_overlay_v1","observed_at":"2026-09-24T08:30:00+01:00","assets":[{
            "asset_ref":"catalog:product:nevoa","source":"manual_operations_review",
            "operational":{"unit_material_cost_minor":180,"packaging_cost_minor":70,"production_minutes_per_unit":5,"batch_capacity_units":30},
            "evidence_refs":["manual:ops:test"]}]}
        with tempfile.TemporaryDirectory() as tmp:
            path=Path(tmp)/"facts.private.json"; path.write_text(json.dumps(overlay),encoding="utf-8")
