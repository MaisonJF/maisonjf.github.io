...
def main() -> None:
    ...
    proc=subprocess.run(
        [sys.executable,"-m","unittest","-v","test_runtime_contract.py","test_private_runtime_preflight.py","test_render_private_worker_config.py","test_remote_schema_gate.py","test_private_brain_health.py","test_verify_private_brain_boundary.py","test_private_deploy_workflow.py","test_private_runtime_readiness.py","test_cloudflare_readonly_inspect_workflow.py","test_brain_ci_workflows.py","test_observe_host_preflight.py","test_activation_doctor.py","test_osiris_bridge_contract.py","test_brain_mcp_contract.py"],
