...
class A14RecoveryRepositoryTests(unittest.TestCase):
    def make_db(self):
    ...
    def test_private_target_and_a3_contribution_drive_snapshot(self):
        con=self.make_db(); repo=SQLiteA14Repository(con)
        repo.persist_recovery_target({
            "recovery_target_version_id":"rtv_"+"1"*36,
            "target_key":"capital_recovery",
            "target_amount_minor":20000,
            "currency":"EUR",
            "valid_from":"2026-09-23T00:00:00Z",
            "valid_to":None,
            "created_at":"2026-09-23T00:00:00Z",
            "created_by":"private_runtime",
            "notes":{},
        })
        ...
        snap=repo.recovery_snapshot(target_key="capital_recovery",at="2026-09-23T12:00:00Z")
        self.assertIsNotNone(snap)
        self.assertEqual(snap.recovered_contribution_minor,6500)
        self.assertEqual(snap.remaining_minor,13500)
