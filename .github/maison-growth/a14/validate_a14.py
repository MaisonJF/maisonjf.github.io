...
def main() -> None:
    ...
    for test_file in ("test_a14.py", "test_a14_repository.py", "test_cash_engine.py", "test_a14_bridges.py", "test_cash_repository.py", "test_a14_identity.py", "test_validation_planner.py"):
        proc = subprocess.run(
