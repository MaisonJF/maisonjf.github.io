...
| Osiris Memory write mirror | READY authenticated HTTPS bridge | DISABLED / private host required |
| Osiris Memory read context | REFERENCE CONTRACT READY | NOT PROVISIONED |
...
| Maison Semantic Memory | READY stable projection interface | BACKEND UNDECIDED (Qdrant vs pgvector experiment) |
...
2. Provision persistent/runtime infrastructure without external activation.
