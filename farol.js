...
(function() {
  ...
  const FAROL_DATA = {
    ...
    results: {
      decisao_voltas: result('Já fizeste listas. Continuas no mesmo sítio.', 'Já tens informação. O que não tens é descanso. Uma Consulta pode ajudar-te a olhar para o que estás a evitar e para o que realmente queres, sem decidir por ti.', 'servicos#tarot', 'Ver Tarot e Consultas'),
      decisao_medo: result('No fundo já escolheste. O medo é teres de viver com a escolha.', 'Quando imaginas todas as maneiras de a escolha correr mal, não avançar pode parecer mais seguro. Podemos olhar para cenários, receios e aquilo que estás a evitar, sem escolher por ti.', 'servicos#tarot', 'Ver Orientação'),
      decisao_urgente: result('Não queres pensar nisto mais uma semana.', 'Se a questão é concreta e urgente, o Tarot Expresso foi pensado para perguntas pontuais. Se precisares de mais contexto, há formatos mais completos.', 'servicos#tarot', 'Ver Consultas'),

      relacao_cabeca: result('Dizes que já passou. Depois vais outra vez ver se escreveu.', 'Relês mensagens, refazes conversas e imaginas respostas que talvez nunca venham. Uma Consulta pode ajudar a perceber o que te prende ali; se isto já se arrasta, há Acompanhamento.', 'servicos#tarot', 'Ver Orientação', 'servicos#acompanhamento', 'Ver Acompanhamento'),
      relacao_decidir: result('O pior é não saber se esperas ou vais embora.', 'Se qualquer escolha te parece perigosa, vais continuar sem avançar. Uma Consulta ajuda-te a olhar para o que existe de facto, para o que temes e para o que queres, sem decidir por ti.', 'servicos#tarot', 'Ver Consultas'),
      relacao_entender: result('Estás cansado(a) de tentar perceber o que isto significa.', 'Começa por uma Consulta focada na situação. Se o assunto já se arrasta e uma resposta isolada não chega, há Acompanhamento.', 'servicos#tarot', 'Ver Consultas', 'servicos#acompanhamento', 'Ver Acompanhamento'),

      cansaco_corpo: result('Até cuidar de ti parece mais uma tarefa.', 'Não precisas de transformar a vida toda hoje. O Escalda-Pés começa com água morna, aroma, espuma suave e dez a vinte minutos em que não tens de produzir nada.', 'produto-escalda-pes', 'Quero criar a minha pausa', 'produto-oleo-massagem', 'Prefiro toque e massagem'),
      cansaco_cabeca: result('Deitaste o corpo. A cabeça continua em pé.', 'Se ainda estás a responder mentalmente à conversa, ao trabalho ou ao problema, muda primeiro o ambiente do quarto e marca a passagem para a noite.', 'produto-aguas-lencois', 'Quero mudar o quarto', 'produto-vela-aromatica', 'Prefiro luz e aroma'),
      cansaco_demais: result('Acordas cansado(a) antes de o dia começar.', 'Se acordas cansado(a) antes de o dia começar, isto já não é só o cansaço de hoje. Podes começar por uma conversa e perceber se precisas de continuidade.', 'servicos#acompanhamento', 'Ver Acompanhamento'),

      casa_cheiro: result('Queres entrar e sentir logo outro ar.', 'A Névoa de Ambiente muda o cheiro do espaço em segundos e pode marcar o momento em que o dia fica do lado de fora.', 'produto-bruma-ambiente', 'Quero mudar o ar', 'produtos', 'Comparar todos os produtos'),
      casa_parar: result('Queres que a casa te diga: acabou por hoje.', 'Luz e aroma criam uma fronteira simples entre o dia e a noite. Acende a vela e deixa a divisão mudar de ritmo.', 'produto-vela-aromatica', 'Quero marcar o fim do dia', 'produto-escalda-pes', 'Prefiro uma pausa para o corpo'),
      casa_mudar: result('Não queres obras. Queres sentir a casa diferente.', 'Começa pelo que muda mais depressa: o ar. A Névoa de Ambiente cria uma diferença perceptível sem mexeres na casa toda.', 'produto-bruma-ambiente', 'Quero sentir outro ambiente', 'produtos', 'Ver todas as opções'),

      aprender_tarot: result('Queres aprender Tarot. A sério.', 'Então não te vou mandar para três frases num ebook. A Mentoria existe para aprendizagem estruturada e acompanhamento.', 'servicos#acompanhamento', 'Ver Mentoria'),
      aprender_astrologia: result('Queres perceber o mapa, não decorar signos.', 'As Análises e os Relatórios de Astrologia são preparados sob encomenda. Também há Numerologia e outras Terapias Complementares sob consulta, conforme o que pretendes aprofundar.', 'servicos#astrologia', 'Ver Astrologia'),
      aprender_outra: result('Queres começar. Ainda não sabes por onde.', 'Vê os serviços e, se nada encaixar, fala com a Maison. Primeiro percebemos o que procuras. Depois vemos se existe uma solução real.', 'servicos', 'Explorar Serviços'),

      companhia_evento: result('Já tens o convite. O problema é chegares sozinho(a).', 'O Friend4Rent existe precisamente para isso: Eventos, Jantares e outros Compromissos Sociais em que queres ter alguém contigo, sem dimensão romântica.', 'companhia#friend4rent', 'Ver Friend4Rent'),
      companhia_sair: result('Queres fazer o plano. Sozinho(a), sabes que vais desistir.', 'Se o plano continua a apetecer-te e o que te trava é ires sozinho(a), o Friend4Rent pode ser a companhia que falta para saíres pela porta.', 'companhia#friend4rent', 'Ver Friend4Rent'),
      companhia_falar: result('Queres conversa e presença. Não um encontro.', 'Se procuras Companhia sem romance, o Friend4Rent pode ser exactamente isso: tempo partilhado, conversa e uma actividade combinada.', 'companhia#friend4rent', 'Ver Friend4Rent'),
      companhia_afecto: result('Hoje querias alguém perto. Com carinho e um pouco de romance.', 'Se procuras uma presença mais próxima, calorosa e romântica, o Boyfriend4Rent pode incluir dar a mão, abraços, carinho leve e beijos leves previamente combinados. Sem sexo nem Serviços Sexuais.', 'companhia#boyfriend4rent', 'Ver Boyfriend4Rent'),

      presente_qualquer: result('Não queres entregar uma coisa que parece comprada cinco minutos antes.', 'Escolhe pelo que a pessoa vai usar: casa, corpo, aroma ou pausa. Se não souberes, diz-nos para quem é e ajudamos-te a reduzir as opções.', 'produtos', 'Ver Produtos'),
      presente_casa: result('Queres que a pessoa use e se lembre de quem ofereceu.', 'Uma Vela Aromática cria luz, aroma e presença no espaço. Se quiseres comparar com Névoa ou Águas de Lençóis, também tens todas as opções reunidas.', 'produto-vela-aromatica', 'Quero ver a Vela', 'produtos', 'Comparar presentes para a casa'),
      presente_corpo: result('Queres oferecer um momento em que a pessoa pare.', 'O Escalda-Pés oferece uma pausa concreta, sem exigir uma rotina complicada. Se a pessoa prefere toque, tens também o Óleo de Massagem.', 'produto-escalda-pes', 'Quero oferecer uma pausa', 'produto-oleo-massagem', 'Ver Óleo de Massagem'),

      outro_ver: result('Sem problema. Vai directo ao que existe.', 'Produtos, Serviços, Acompanhamento e Companhia estão reunidos no site. Começa pelo que te chama a atenção e vê se resolve alguma coisa real.', 'index#explorar', 'Explorar a Maison'),
